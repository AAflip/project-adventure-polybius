...
let storyObj = {
    story: {
        text: {
            ...
            corpFallout2: [`I turned my head to see what he was looking at. I am met with a video of us going through the compound and eventually I see us dealing with the android. I look around and there are people all around us giving us stares.`],
            ...
            goodDecision: [`Absolutely disgusted by the fact that I was working for a company that had done this to beings that could feel and think for themselves`, `goodOutreach`],
            ...
            goodOutreachD: [`“Hey you, You looked at that file didn’t you?” a man dressed in all black asked. I felt the sweat bead up on my palms, if the company knew I had looked at those files my life would be over.`, 'goodOutreachD2'],
            goodOutreachD2: [`“Don’t worry too much, as far as we know the company ain’t found out about your little perusing through confidential files ” said the other man dressed in all black.`, 'goodOutreachD3'],
            goodOutreachD3: [`“We wanted to ask you to join our organization, we think you might be interested,” the man said.`, 'goodOutreach2'],
            goodOutreach2: [`After speaking, he handed me a contact card with a phone number on it. They both left suddenly leaving me to gather my thoughts. I went home and mulled over the multiple ways I could get killed if I called them right now, but I realized I needed to know what their goal was. I picked up my phone and dialed the number.`, 'goodOutreachD4'],
            goodOutreachD4: [`Wayne: “Our goal? It’s quite simple, we want to free the androids” I stiffened at what he said.`, 'goodOutreach3'],
            goodOutreach3: [`Although I had come prepared to hear something outrageous, I didn’t think I would hear this.`, 'goodOutreachD5'],
            goodOutreachD5: [`“You can’t just say these things with no plan, it’s impossible to get other humans to see these androids as anything other than robots”`, 'goodOutreachD6'],
            goodOutreachD6: [`“But I do”`, 'goodOutreachD7'],
            goodOutreachD7: ['“...”', 'goodOutreachD8'],
            goodOutreachD8: ['“Of course, until you join us I cannot divulge any information to you until you join our organization, so will you join us?”', 'goodOutreachD9'],
            goodOutreachD9: ['“...Alright, I will join”', 'goodOutreachD10'],
            goodOutreachD10: ['“Great, good to have you onboard, for now your job will be to complete some odd tasks here and there. Thankfully we have an easy job for you to complete first go to our lockers and change into something inconspicuous”', 'goodMissionIntro'],
            goodMissionIntro: ["“We will be supplying you with some items but don't be too careless, theres still some risk as the target knows that we are onto him. This guys the cautious type so it's likely he's engaged his security defenses you may have to turn them off. Your job is to go in talk to him and convince him we are on the same side. You can interact with the puzzles by clicking on your screen.”", 'goodMissionFiller'],
            goodMissionFiller: ["Nearly 30 minutes later, I arrive at the apartment building. I grab my items and prepare to enter. Luckily the door seems to be unlocked, so I open it", 'goodBackOut'],
            goodBackOut: ["As I see off the target after escorting him I can't help but still feel unsure if I still want to do this. I take a moment to gather my thoughts away from the prying eyes of this organization and decide", '@?goodStay'],
            goodStay: ['to stay with this organization and continue on this path to help the androids', 'goodPropD1'],
            goodPropD1: [`“I’m glad you decided to stay with us, so many potential members run away”`, 'goodPropD2'],
            goodPropD2: [`“Well, of course I would stay and help a good cause, so what do you guys actually do?”`, 'goodPropD3'],
            goodPropD3: [`“Oh well, as I already told you our main goal is to help androids be free"`, 'goodPropD4'],
            goodPropD4: [`“And how do you do this?”`, 'goodPropD5'],
            goodPropD5: [`“We track down and try to persuade them to our side just like we did to you”`, 'goodPropD6'],
            goodPropD6: [`“And if they don’t want to join?”`, 'goodPropD7'],
            goodPropD7: [`“Well we can’t force them so we just wipe their memories of that interaction and go on our way”`, 'goodPropD8'],
            goodPropD8: [`“Memory-wiping technology? I’ve never heard of that”`, 'goodPropD9'],
            goodPropD9: [`“Of course you haven’t”  …Fair point`, 'goodAllyD1'],
            ...
            goodAllyEnter: [`The door opens to my side as the leader stops talking. A tall rebel who I had seen a couple of times walks through the open doorway, stopping in front of me. He sticks his hand out towards me before introducing himself.`, 'goodAllyD2'],
            goodAllyD2: [`“Hey, my name is Jaxon, nice to meet you”`, 'goodAllyLast'],
            goodAllyLast: [`I shake his hand and reciprocate his introduction with my own. Turning to face the boss when he begins to talk again`, 'goodMission2Choice'],
            goodMission2Choice: [`“Well, now that you two have gotten acquainted with each other, let me tell you about your mission. You actually have a choice between missions this time around, you could either go down to the sewers and capture a Cyberlife mercenary who has been sniffing around a base of ours down there, or go and tail a member of Cyberlife’s intel department, that one might have you meet some extra mercenaries though.”`, '@?goodMission2_1'],
            goodMission2_1: [` I decided, after thinking for a few seconds, that I would rather capture the one mercenary than have a chance to fight multiple. I turned to Jaxon to ask his opinion, but the reply I received was, “Up to you man”`, 'goodMission2_1D1'],
            goodMission2_1D1: [`“Alright then, first one it is. Our base is located in the sewers under Main Street. We’ll put a sewer map in your car so you can find your way through to the base”`, 'goodMission2_1Room'],
            goodMission2_1Room: [`20 minutes later we’re wading through the city’s main sewer system, glancing at the map every few seconds, looking for the small room that the rebellion calls a base. Soon enough, we round a corner to see an open doorway leading to the small room the map calls the base. In the center of the room, a figure is crouched with their back turned to us. Jaxon rushes forward, attempting to capture the figure, but trips on a 2x4 and falls to the ground, alerting our target to our presence. The man runs through the door on the other side of the room, slamming it closed before I could reach him. The slamming of the door seems to have activated a kind of security system in the room, barring me from opening the door`, 'goodMission2_1D2'],
            goodMission2_1D2: [`“According to the map that path is a deadend, so all we need to do is open that door and we can finish our mission. Looks like you’ll have to disable the security system first.”`, 'goodMission2_1D3'],
            goodMission2_1D3: [`“Okay, now that the doors open he should be right there, so be ready to fight”`, 'goodMission2_1Fight'],
            goodMission2_1Fight: [`I nod as Jaxon reaches over and opens the door, revealing the nervous man`, 'goodMission2_1D4'],
            goodMission2_1D4: [`“Good job, now let’s get back to hq before we get spotted-”`, 'goodMission2_1D5'],
            goodMission2_1D5: [`“It’s too late for that! I have been watching and broadcasting since you entered the room! Now no one will ever help you again!”`, 'goodFalloutD1'],
            goodMission2_2: [`I decided, after thinking for a few seconds, that I would rather learn information, than try to kidnap someone, even if they were evil. I turned to Jaxon to ask his opinion, but the reply I received was, “Up to you man”`, 'goodMission2_2D1'],
            goodMission2_2D1: [`“Alright then, second one it is. You can find the person you need to tail in the xxSt Diner, they should be wearing a brown leather coat. If he does spot you though, make sure to take him out, we can’t have anyone knowing we are tailing them”`, 'goodMission2_2Diner'],
            goodMission2_2Diner: [`15 minutes later, we’re sitting in the same diner as our target, discreetly watching them as they eat their meal. Not long after we finish our own meals, the target pays for their food and exits the diner, prompting us to do the same. We follow them for a couple of minutes, eventually watching them duck into a nearby alleyway and enter what looks to be an abandoned house. We try to quietly enter after the rebel, but Jaxon accidentally knocks an aluminum trash can to the ground, alerting them to our presence. We all freeze for a moment, waiting for the others to move. The mercenary snaps out of the daze first, diving through the door at the back of the house and locking it behind them`, 'goodMission2_2D2'],
            goodMission2_2D2: [`“I didn’t see any windows or doors on that side of the building outside, so all we need to do is open that door and we can finish our mission. Looks like you’ll have to disable the security system first”`, 'goodMission2_2D3'],
            goodMission2_2D3: [`“Okay, now that the doors open he should be right there, so be ready to fight”`, 'goodMission2_2Fight'],
            goodMission2_2Fight: [`I nod as Jaxon reaches over and opens the door, revealing the battle ready mercenary`, 'goodMission2_2D4'],
            goodMission2_2D4: [`“Good job, now let’s get back to hq before we get spotted-”`, 'goodMission2_2D5'],
            goodMission2_2D5: [`“It’s too late for that! I have been watching and broadcasting since you entered the room! Now no one will ever help you again!”`, 'goodFalloutD1'],
            goodFalloutD1: [`“Let's hurry up and get out of here already”`, 'goodFallout'],
            goodFallout: [`As we stepped out from the door/sewer we immediately could tell something was off. I look over to my left to see Jaxon looking at something off in the distance`, 'goodFalloutD2'],
            goodFalloutD2: [`“That's not good”`, 'goodFallout2'],
            goodFallout2: [`I turned my head to see what he was looking at. I am met with a video of us going through the compound and eventually I see us dealing with the android. I look around and there are people all around us giving us stares`, 'goodfalloutD3'],
            goodfalloutD3: [`“Hey! Stop spacing out, we need to get to the hideout before anybody recognizes us!”`, 'goodFallout3'],
            goodFallout3: [`We push through the crowd that is forming and stick to the back streets to avoid detection. While we are doing this I can’t help but think if I’m sure if I still want to go down this route`, 'goodFallout4'],
            goodFallout4: [`I thought that I would be in more trouble but it was agreed upon that this may be a blessing in disguise. So it’s been decided that I will give a speech as I’m the one who has their face shown in the video.`],
            goodFalloutD4: [`“The public is more outraged than expected.. There's no time, you'll just have to make the speech up, on the way”`, 'goodFalloutD4'],
            goodFallout5: [`I could only nod as it was our carelessness that led to the whole operation being exposed. As I step out the car someone tries to egg me but I'm able to catch it before it hits me. I then started walking up to the podium to give my speech. I am now standing in front of the podium where I start to speak`, 'goodFallout5'],
            goodSpeech: [`“Hello my name is XXXX and I was the one seen in the video with the android. Now I’m sure all of you have many questions, many of which I cannot answer. I cannot answer these questions as the situation is still developing. But…” What should I say after this?`, '@?goodSpeech'],
            goodSpeechCalm: [`“I know many of you have come here today with preconceived notions that androids could never be sentient and able to feel emotions just like a human can. However, that line of thinking couldn’t be further from the truth”`, '@?goodSpeechBadResult1'],
            goodSpeechRelatable: [`“I know how many of you feel, in truth I used to have the same reservations as you. But through my own journey I have realized that androids are sentient just like humans”`, 'goodSpeechBadResult1'],
            goodSpeechBadResult1: [`The crowd roars with disagreement, maybe I came off as trying to pander to them? Well, I can’t think about it too much unless I want to get pelted by whatever the crowd throws at me. As I’m running away from the podium to escape the mob. Jaxon drags me into a back alley away from the crowd’s sights`, 'goodSpeechBadD1'],
            goodSpeechBadD1: [`Well that was a shitshow, anyways we need to get back to the hideout there's been an update. We may be able to defeat CyberLife once and for all`, 'goodLore'],
            goodSpeechAssertive: [`“How many of you have interacted with Androids? I’m assuming all of you because that's how much this city has come to rely on them. Androids have been working for us for years yet have none of you thought that they could hold any semblance of life? They look exactly like humans and the Android I encountered that day definitely was human in the most important sense of the word”`, 'goodSpeechGoodResult'],
            goodSpeechGoodResult: [`The crowd roars with agreement. As I’m about to go on further Darryl stops me`, 'goodSpeechGoodD1'],
            goodSpeechGoodD1: [`“Alright everybody we have given you more insight into the situation, now we will be departing”`, 'goodSpeechGoodD2'],
            goodSpeechGoodD2: [`Anyways we need to get back to the hideout there's been an update. We may be able to defeat CyberLife once and for all”`, 'goodLore'],
            goodSpeechAggressive: [`“How many of you have interacted with Androids? I’m assuming all of you because that's how much this city has come to rely on them. Androids have been working for us for years yet have none of you thought that they could hold any semblance of life? They look exactly like humans and the Android I encountered that day definitely was human in the most important sense of the word”`, 'goodSpeechBadResult2'],
            goodSpeechBadResult2: [`The crowd roars with disagreement, maybe I came off too aggressive at the start? Well, I can’t think about it too much unless I want to get pelted by whatever the crowd throws at me. As I’m running away from the podium to escape the mob. Jaxon pulls me into a nearby alley`, 'goodSpeechBadD1'],
            goodLore: [` “The current loss of life is mainly due the ever increasing carbon emissions and the acidity of the ocean. Things were looking bleak during this time, it was so hot that no one dared to step outside, keeping themselves shut inside their air-conditioned homes. This would only fuel the carbon-emissions causing everything to keep worsening. There had been plans to create protective barriers that would block out the heat and carbon in the atmosphere, however these had not been created in time to be set up. Out of all this came a man named James Acrid who revolutionized labor. His genius mind created the body and ai for modern day androids that is still used today. Thanks to this, cities were able to set out workers that would never get tired or complain about the heat and were able to put together the first protective barrier. That barrier still stands today in this city”`, 'goodLore2'],
            goodLore2: [`“Alright but how is this important to defeating CyberLife? This is basic knowledge”`, 'goodLore3'],
            goodLore3: [`“I’m getting there, as you and everybody in this room have figured out the AI part of androids may be sentient, but how did this happen? The answer? It was in the design from the very start. James Acrid was a genius but not even he could design an AI that could do almost everything a human could. That’s why a majority of the AIs he designed are based on the human brain”`, 'goodLore4'],
            goodLore4: [`As you mull over this information you realize it makes sense. It would presumably be hard for anything else other than humans to gain sentience as humans are the only animal to evolve it after billions of years`, 'goodLore5'],
            goodLore5: [`“That’s not all though, one of James Acrid’s final words was that he will leave everything dear to him resting in his tomb. However no one ever realized why he said those words or why he said those words or where his tomb was. That was until today as we have gained some intel that clues us in where James Acrid’s final resting place is and what exactly is in that tomb. However we need to be fast as it is likely that this info has spread to CyberLife. If everything goes well this will be your final mission. Stay sharp”`, 'goodMission3'],
            goodMission3: [`The tomb was revealed to be outside of the city’s protective barrier allowing it to go undetected for quite some time. We’ve been riding in this car for hours and had to get special equipment to block out the heat just like the city does. Now as we approach our destination I am surprised at how the tomb looks like its in quite the pristine condition. Every other building has collapsed due to. To be honest I thought a tomb would be more ancient but I guess since the guy died in modern times it wouldn’t look that ancient. We pull up to the tomb and stop the car`, 'goodMission3D1'],
            goodMission3D1: [`“All right lets head out”`, 'goodMission3D2'],
            goodMission3D2: [`“There are signs of the building being actively maintained so be on guard”`, 'goodMission3Room'],
            goodMission3Room: [`As we enter the entrance I take note of the intricate symbols all over the walls. They seem to be glowing in response to something. Suddenly a loud crash is heard throughout the tomb, as I look towards the noise I see an old military robot silently looking at us from a hole in the wall. I'm hoping it doesn't see us when Jaxon suddenly starts running towards it`, 'goodMission3D3'],
            goodMission3D3: [`“Been waiting for a fight!”`, '|?|goodMission3Puzzle'],
            goodMission3Puzzle: [`After the robot is done collapsing we quickly go towards the hole in the wall it came out of. In it we find a large console that spans the entire room. In the center lies an old circuit board that seems to have shorted out. Looks like I'll have to replace it`, '%?goodMission3Key'],
            goodMission3Key: [`The power now seems to be flowing. Nothing happens for a moment and I start to get frustrated however that's when on the other side of the room a panel opens and a robot hand comes out. I go up to it and I see that it has some sort of key in its hand`, 'goodMission3D4'],
            goodMission3D4: [`???: “Thanks for finding that for me”`, 'goodMission3E'],
            goodMission3E: [`As I hear that voice a large crash rebounds throughout the entire tomb`, 'goodTurningPoint'],
            goodTurningPoint: [`…Everything hurts seriously bad right now. I try to look around but I can't see much but rubble all around me. It seems that the rubble around me formed a pocket that prevented me from being crushed. I look more closely at the cracks of the rubble around me and see light streaming through a crack. I start clawing at the crack to make it larger and eventually I'm barely able to fit my head through the crack. I poke my head through and the first thing I see is that the tomb is completely ruined, it looks like a missile striked it leaving nothing but rubble in it's wake. The next thing I see is somebody talking to Jaxon`, 'goodTPD1'],
            goodTPD1: [`“Why are you doing this?”`, 'goodTPD2'],
            goodTPD2: [`“The key is much more powerful than you would think. It has the ability to save androids or destroy their last hopes”`, 'goodTPD3'],
            goodTPD3: [`“...I see, well get this over with already”`, 'goodTPD4'],
            goodTPD4: [`“Don't worry I will”`, 'goodTP2'],
            goodTP2: [`The figure moves to grab their pistol. I am about to scream out when Jaxon looks me dead in the eyes. I can tell what he's asking me to do but I'm not sure if I have the strength to do it. Jaxon mouths the words “The Hideout”`, 'goodTPD5'],
            goodTPD5: [`“Do you have any last words?”`, 'goodLastWords'],
            goodLastWords: [`“None”`, 'goodTP3'],
            goodTP3: [`I move my head back into the pocket and cover my ears as the shot that rings out deafens me more than any shot I've heard before`, 'goodMission4'],
...
I get back in our car and silently drive back to the city, preparing myself for what I need to do.Now, after a couple hours of driving, I stand outside the Hideout. It hasn’t been that long since what happened at the tomb, so I doubt many know that I’m supposed to be dead. I step through the hideout door with enough fake confidence to hopefully hide my nervousness. Luckily, no one seems to bat an eye as I stroll through the building towards the back, where our leader’s office was. I twist the doorknob, but instead of swinging open, the door stays shut. I guess he saw me walk in on the cameras and decided to turn on his security system, I’ll need to take it down first before I can get to him.`, 'goodM4AfterPuzzle'],
            goodM4AfterPuzzle: [`The door swings open as I twist the last wire into place, revealing the Rebel Leader looking straight at me`, 'goodM4D1'],
            goodM4D1: [` “I see you’re still alive, I thought the explosion had killed you.”`, 'goodM4D2'],
            goodM4D2: [`“You thought wrong, and now I’m here to kill you and take back the key” I raise my sidearm and level it with his head`, 'goodM4Choice'],
            goodM4Choice: [`“Hold on now, the decision wasn’t personal! We sure if we could trust you guys to resist any offers made by CyberLife. We couldn’t afford CyberLife or their people getting their hands on the key. We’re all on the same side here, so why don’t you put the gun down?”`, '@?'],
            goodSpareM: [`“Fine, but I’m still taking the key”`, 'goodSpareM2'],
            goodSpareM2: [`“Be my guest” He slides the key out of his pocket and hands it over suspiciously easily. I turn to leave, intending to go home and rest, but his next comment stops me in my tracks. Mentor: “We found where the key goes, too, Acrid’s old research facility in the slums. If you want things to end, I would go there”`, 'goodSpareM3'],
            goodSpareM3: [`My feet continue their original objective, taking me out of the building, but instead of walking home, I turn in the direction of the slums. It's time to end things once and for all`, 'goodAmbush'],
            goodKillM: [`He barely gets the last word out before I put lead between his ears. I let his body fall to the floor before approaching, reaching into his pocket to pull out the key that's wrapped in a piece of crumpled paper. Unfurling the paper from the key reveals the message written on it, the location of the lock to this key. Stuffing the letter and key into my pocket, I exit the building heading to my new objective in the slums, Acrid’s old research facility. It's time to end things once and for all.`, 'goodAmbush'],
            goodAmbush: [`I manage to make it all the way through the city to the facility without a single problem, right until I reach for the facility’s door.`, 'goodAmbushD1'],
            goodAmbushD1: [`“Stop there rebel, hand over the Acrid’s key now, and we’ll give you a mostly painful death”`, 'goodAmbushD2'],
            goodAmbushD2: [`“The key is mine, if you want it you’ll have to take it”`, 'goodAmbushD3'],
            goodAmbushD3: [`“Very well then, painful death it is”`, '|?|'],
